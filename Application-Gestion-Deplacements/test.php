<?php 
  ...
  $ReadSql = "SELECT * FROM deplacement d
  WHERE date_depart IN (SELECT d2.date_depart
  FROM deplacement d2
  WHERE d.id_deplacement <>d2.id_deplacement)
  and date_arrivee IN (SELECT d2.date_arrivee
  FROM deplacement d2
  WHERE d.id_deplacement <>d2.id_deplacement)		
  and ville_arrivee IN (SELECT d2.ville_arrivee
  FROM deplacement d2
  WHERE d.id_deplacement <>d2.id_deplacement) order by ville_arrivee 	 ";
...
<body>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="the"><pre><h1 > Deplacements</h1></pre></div>
            </div>
            <div class="heading">
